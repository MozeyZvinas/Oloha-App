    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView showsVerticalScrollIndicator={false} className={"space-y-6 "+topMargin}>
        ...
        <View className="mx-5 flex-row justify-between items-center">
          <View>
          <Text style={{fontSize: wp(5)}} className="font-bold text-neutral-700">Hanoi, Vietnam</Text>
          <Image source={require('../../assets/images/cloud.png')} style={{height: wp(8), width: wp(8)}} />
          </View>
          <TouchableOpacity>
